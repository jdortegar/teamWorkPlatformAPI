...
var userOrgSubs = [
   ...
   [
      { Item: { userInfo: { emailAddress: 'son.dao@habla.ai', firstName: 'Son', lastName: 'Dao', displayName: 'Son Dao', country: 'US', timeZone: 'America/Los_Angeles', icon: null, password: '$2a$11$fT4XWeKcQqW3daoSJdKILO4UDJIXNmtqimkvoj.y2PjEOcRhCVLZG' }, userId: 'ea794510-cea6-4132-0000-aa8e1d32abb5', partitionId: -1 }, TableName: tablePrefix + 'users' },
...
messages = [
   ...
   { Item: { messageInfo: { created: '2017-10-08T09:23:12Z', createdBy: 'ea794510-cea6-4132-ae22-a7ae1d32abb5', text: 'Thanks again for the invite but I had work to catch up on.', messageType: 'text', conversationId: 'ea794510-cea6-4132-0023-a7ae1d32abb5', replyTo: 'ea794510-cea6-4132-0030-a7ae1d32abb5' }, messageId: 'ea794510-cea6-4132-0026-a7ae1d32abb5', partitionId: -1 }, TableName: tablePrefix + 'messages' },
   { Item: { messageInfo: { created: '2017-10-08T09:23:20Z', createdBy: 'ea794510-cea6-4132-ae22-a7ae1d32abb2', text: 'It\'s okay. Maybe next time.', messageType: 'text', conversationId: 'ea794510-cea6-4132-0023-a7ae1d32abb5', replyTo: 'ea794510-cea6-4132-0025-a7ae1d32abb5' }, messageId: 'ea794510-cea6-4132-0031-a7ae1d32abb5', partitionId: -1 }, TableName: tablePrefix + 'messages' },
   { Item: { messageInfo: { created: '2017-10-08T09:23:34Z', createdBy: 'ea794510-cea6-4132-ae22-a7ae1d32abb5', text: 'Oh, that was too bad. I bet it was nice to be outside though. The weather was great. I unfortunately had to go to the office.', messageType: 'text', conversationId: 'ea794510-cea6-4132-0032-a7ae1d32abb5' }, messageId: 'ea794510-cea6-4132-0028-a7ae1d32abb5', partitionId: -1 }, TableName: tablePrefix + 'messages' },
   ...
   { Item: { messageInfo: { created: '2017-10-08T09:23:34Z', createdBy: 'ea794510-cea6-4132-ae22-a7ae1d32abb5', text: 'Yes, I did. They all looked fine. I think the client will be in for a nice surprise. We are going to over deliver on what we promise.', messageType: 'text', conversationId: 'ea794510-cea6-4132-0034-a7ae1d32abb5' }, messageId: 'ea794510-cea6-4132-0030-a7ae1d32abb5', partitionId: -1 }, TableName: tablePrefix + 'messages' }
];
addDocuments(messages);
